...
class MainResumeModel {
  ...
  Future<MainResumeListEntity> getResumeList(BuildContext context, bool isNearby,
      bool isNews, bool isRecommend, String jobName, int pageIndex,int pageSize,{String city,String education,String salary,String sex,String workDate,String industryId,String positionId,String recruiterId}) async {
    MainResumeListEntity resumeEntity = await NetUtils.getMainResumeList(context, isNearby, isNews,isRecommend,pageIndex,pageSize,city: city,education: education,salary: salary,sex: sex,workDate: workDate,industryId: industryId,positionId: positionId,recruiterId: recruiterId);
