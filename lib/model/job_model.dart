...
class JobModel with ChangeNotifier {
  ...
  Future<JobListEntity> getJobList(BuildContext context, bool isNearby,
    ...
    JobListEntity jobEntity = await NetUtils.getJobList(context, isNearby, isNews,isRecommend,pageIndex,pageSize,city: city,age:age,education: education,salary: salary,scale:scale,jobSeekerId: jobSeekerId,positionId: positionId,industryId: industryId);
