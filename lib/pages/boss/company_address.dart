...
class AddressResult{
	 ...
	 AddressResult(this.cityId, this.cityName, this.detailAddress);
}
class CompanyAddress extends StatefulWidget {
  ...
  const CompanyAddress({Key key, this.cityId='', this.cityName='', this.detailAddress=''}) : super(key: key);
...
class _State extends State<CompanyAddress> {
	String _cityId;
	String _cityName;
		    ...
		    rightAction: Container(
			    ...
			    child: GestureDetector(
				    onTap: () {
				    	...
				    	Navigator.pop(context,AddressResult(_cityId, _cityName, _detailController.text));
				    },
				    child: Text("保存",
					    style: TextStyle(
